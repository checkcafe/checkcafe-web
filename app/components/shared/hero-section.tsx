...
export default function HeroSection() {
    return (
        <section className="bg-[#F6EBDA] py-10 md:py-[74px]">
            <div className="container mx-auto px-5 md:px-[139px] flex flex-col-reverse md:flex-row gap-5 md:gap-0  justify-between">
                <div className="pt-2 md:pt-14">
                    ...
                    <h1 className="text-[#372816] font-jacques text-4xl md:text-5xl">Enjoy your work</h1>

                    <p className="text-[#9BA0A7] text-lg md:text-2xl mt-10">Your Cozy Workspace Awaits</p>
                ...
                <div className="relative px-6 md:px-0">
                    <img src="/hero-image.jpg" width={500} height={500} className="rounded-md"></img>
                    <FloatingCard
                        title="Price: $-$$$"
