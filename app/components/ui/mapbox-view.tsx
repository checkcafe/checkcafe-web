...
import { Map, Source, Layer, type MapRef, type GeoJSONSource } from "react-map-gl"
import { type GeoJSONFeature } from "mapbox-gl"
import { type FeatureCollection } from "geojson"

import "mapbox-gl/dist/mapbox-gl.css"
import { clusterCountLayer, clusterLayer, unclusteredPointLayer } from "~/configs/layer"
...
export function MapboxView({
    ...
    const onClick = (event: any) => {
        ...
        if (featureProperties.type === "Place") {
            ...
            ;(mapRef.current?.getSource("places-source") as GeoJSONSource)?.setData(updatedGeojson)
        }
    }
    ...
    return (
        <Map
            ...
            interactiveLayerIds={[String(clusterLayer.id), String(unclusteredPointLayer.id)]}
            onClick={onClick}
