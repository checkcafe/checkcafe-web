...
export default function Places() {
    ...
    // Fungsi untuk scroll ke card yang diinginkan
    const handleScrollToCard = (placeId: string) => {
        const cardIndex = dummyFavourite.findIndex((place: any) => place.id === placeId)
        ...
        <div className="container mx-auto px-8 flex flex-col gap-8 pt-5">
                    ...
                    <span>
                        ...
                        <span className="flex gap-6">
                            <div className="w-1/2">
                                ...
                                <Input placeholder="Rp 50.000" id="from" name="from" type="number" />
                            </div>
                            <div className="w-1/2">
            ...
            <div className="flex gap-2">
                ...
                <aside className="w-1/2 h-full sticky top-0">
                    <MapboxView places={dummyFavourite} onPlaceClick={handleScrollToCard} />
                </aside>
            </div>
        </div>
    )
